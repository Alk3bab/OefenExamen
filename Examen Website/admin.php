...
// Verwerk het e-mailformulier
if (isset($_POST['stuur_mail'])) {
    $onderwerp = $_POST['onderwerp'];
    $bericht = $_POST['bericht'];
    $headers = "From: info@premiumwagens.nl"; // Gebruik het juiste e-mailadres
    ...
    <div class="admin-container">
        ...
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li><a href="#" id="email-link">E-mail sturen naar klanten</a></li> <!-- Toegevoegde link -->
            </ul>
        ...
        document.getElementById('email-link').addEventListener('click', function() {
            document.getElementById('main-content').innerHTML = `
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" name="stuur_mail" class="btn btn-primary">Verstuur E-mail</button>
                </form>
            `;
        });
    </script>
